...
package net.yacy.grid.core.api.vis;

import javax.servlet.http.HttpServletResponse;

import net.yacy.grid.graphics.PrintTool;
import net.yacy.grid.graphics.RasterPlotter;
import net.yacy.grid.graphics.RasterPlotter.DrawMode;
...
public class MarkdownService extends ObjectAPIHandler implements APIHandler {
    ...
    public ServiceResponse serviceImpl(Query post, HttpServletResponse response) throws APIException {
        ...
        // write image
        return new ServiceResponse(matrix);
    }
}
