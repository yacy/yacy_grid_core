...
public class OSMTile {
    ...
    public static BufferedImage getSingleTile(final TileCoordinates tile, final int retry) {
        ...
        try {
            ...
            Log.logger.error("OSMTile: cannot open stream: " + e.getMessage());
            return null;
        }
        ...
        try {
            ...
            Log.logger.error("OSMTile: cannot read stream: " + e.getMessage());
        }
        ...
        try {
            ...
            Log.logger.error("OSMTile: cannot parse image: " + e.getMessage());
            return null;
        } catch (final IOException e) {
            Log.logger.error("OSMTile: cannot open image: " + e.getMessage());
            return null;
        }
    }
    ...
    public static class TileCoordinates {
        ...
        public String url(final int retry) {
            ...
            final String host = (hash == 3) ? "tile.openstreetmap.org" : ((char) ('a' + hash)) + ".tile.openstreetmap.de";
